# Per-layer failure attribution — `recall_v8_1778053915_agent_api_stage`

Generated: 2026-05-06T07:55:50.239Z
...
| makeup_lip | en | 3 | 0 | 0 | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 0 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| shopping_agent | 53 | 12 (23%) | 1 | 12 | 18 | 8 | 0 | 0 | 0 | 0 | 2 |
...
| shopping_agent | makeup_lip | en | `nude lipstick everyday` | 0 | EMPTY | C-external_seed | seed_ran_returned_zero (executed=true, raw=0, returned=0) | 0 | 0 | true | cache_miss_sync_filled |
| shopping_agent | makeup_lip | en | `matte lipstick under $30` | 0 | EMPTY | C-external_seed | seed_ran_returned_zero (executed=true, raw=0, returned=0) | 0 | 0 | true | cache_miss_sync_filled |
