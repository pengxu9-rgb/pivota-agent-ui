...
export function ProductsPageClient({
  ...
  // Server-rendered browse feed (see page.tsx). Crawlers and no-JS readers get
  // a real product grid with real <a href="/products/sig_*"> links in the
  // HTML; hydration then refreshes it through the normal client fetch, whose
  // response also carries the pagination cursor infinite scroll needs.
  ...
  // Seeded true when the server already rendered a grid: the refresh fetch
  // then shows the subtle "Updating" chip over real products instead of
  // flashing the skeleton over content the reader can already see.
