...
function hasPositivePrice(item: Pick<HistoryItem, 'price'> | undefined): item is HistoryItem {
...
export function mergeHistoryItems(remoteItems: HistoryItem[], localItems: HistoryItem[]): HistoryItem[] {
  ...
  for (const item of remoteItems) {
    ...
    merged.push({
      ...item,
      price: hasPositivePrice(item) ? item.price : hasPositivePrice(localMatch) ? localMatch.price : item.price,
    });
  }
