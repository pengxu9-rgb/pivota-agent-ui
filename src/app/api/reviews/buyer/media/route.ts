...
const _REVIEWS_BUYER_MEDIA_ENVS = [
  'REVIEWS_UPSTREAM_BASE',
  'NEXT_PUBLIC_REVIEWS_UPSTREAM_BASE',
  'NEXT_PUBLIC_REVIEWS_BASE',
  'NEXT_PUBLIC_ACCOUNTS_BASE',
];
if (!_REVIEWS_BUYER_MEDIA_ENVS.some((name) => process.env[name])) {
  warnIfHardcodedFallbackUsed({
    routeLabel: 'api/reviews/buyer/media',
    envVarsTried: _REVIEWS_BUYER_MEDIA_ENVS,
