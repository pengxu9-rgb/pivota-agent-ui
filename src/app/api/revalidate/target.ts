/**
 * Build the exact string the revalidate endpoint will purge.
 *
 ...
 *    degenerates to the parent — `/products`, or under a tag scheme the bare
 *    `pdp` tag that sits on EVERY PDP entry — restoring the full ~4,400-entry
 *    blast radius under a new name.
 *
